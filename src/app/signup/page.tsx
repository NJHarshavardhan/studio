...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden liquid-gradient">
      ...
      <div className="w-full max-w-md space-y-10 relative z-10">
        ...
        <Card className="glass-morphism rounded-[3.5rem] overflow-hidden border-none shadow-2xl">
          ...
          <CardContent className="px-10 pb-14 pt-8">
            {error && (
              <Alert variant="destructive" className="mb-6 rounded-2xl bg-destructive/10 border-none text-destructive">
